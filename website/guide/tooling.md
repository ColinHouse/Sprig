...
- `explain` and `codes` document the stable diagnostic vocabulary in
  [Diagnostic codes](/reference/DIAGNOSTIC_CODES).
...
[Agent tool protocol](/reference/AGENT_TOOL_PROTOCOL); treat it as a design
...
- The repository's own quality gates are deliberate: see the
  [AI-assisted development disclosure](/project/ai-disclosure).
